...
const resources = {
  en: {
    translation: {
      ...
      "secret_on": "ON",
      "secret_off": "OFF",
      "be_secret_genie": "Be a Secret Genie (Anonymous)",
      "secret_genie": "Secret Genie",
      ...
      "payment_config_desc": "Indicate how you want to receive contributions. Djinn does not handle the money, it only facilitates the direct link with your genies.",
  ...
  es: {
    translation: {
      ...
      "share": "Compartir",
      "secret_mode": "Modo Secreto",
      "secret_on": "ACTIVADO",
      "secret_off": "DESACTIVADO",
      "be_secret_genie": "Ser un Genio Secreto (Anónimo)",
      "secret_genie": "Genio Secreto",
      ...
      "payment_config_desc": "Indica cómo quieres recibir las contribuciones. Djinn no maneja el dinero, solo facilita el vínculo directo con tus genios.",
      "payment_type_paypal": "PayPal",
      "payment_type_mercadopago": "Mercado Pago",
  ...
  pt: {
    translation: {
      ...
      "secret_mode": "Modo Secreto",
      "secret_on": "LIGADO",
      "secret_off": "DESLIGADO",
      "be_secret_genie": "Ser um Gênio Secreto (Anônimo)",
      "secret_genie": "Gênio Secreto",
  ...
  fr: {
    translation: {
      ...
      "secret_on": "ACTIVÉ",
      "secret_off": "DÉSACTIVÉ",
      "be_secret_genie": "Être un Génie Secret (Anonyme)",
      "secret_genie": "Génie Secret",
      "settings": "Paramètres",
      "language": "Langue",
      "currency": "Devise",
      "save": "Enregistrer",
